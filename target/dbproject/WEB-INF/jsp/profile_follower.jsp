              ...
              <section class="hbox stretch">
                ...
                <aside class="bg-light lter b-r">
                    <section class="vbox">
                      ...
                      <div class="row">
                        <div class="col-md-9">
                        <h3 class="font-bold">Follower</h3>
                        <table class="table table-striped m-b-none">
                          ...
                          <tbody>
                            <c:forEach var="f" items="${followerlist}" varStatus="loop">
                            <tr>                    
                              <td>${loop.index + 1}</td>
                              <td><a href="<%=basePath%>user/profile_trans.do?uid=${f.uid}">${f.uname}</a></td>
                              <td>${f.ucity}</td>
                            </tr>
                            </c:forEach>
                          </tbody>
