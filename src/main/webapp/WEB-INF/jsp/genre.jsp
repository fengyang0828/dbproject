  ...
  <section class="vbox">
    ...
    <section>
      <section class="hbox stretch">
        ...
        <section id="content">
          <section class="vbox">
            <section class="w-f-md" id="bjax-target" style="bottom: 0px;">
              <section class="hbox stretch">
                <!-- side content -->
                  ...
                  <section class="vbox animated fadeInUp">
                    <section class="scrollable hover">
                      <div class="list-group no-radius no-border no-bg m-t-n-xxs m-b-none auto">
                        <c:choose>
                          <c:when test="${'All' eq type}">
                          <a href="<%=basePath%>user/search_genre.do?type=All" class="list-group-item active">
                            All
                          </a>
                          <a href="<%=basePath%>user/search_genre.do?type=Jazz" class="list-group-item">
                            Jazz
                          </a>
                          <a href="<%=basePath%>user/search_genre.do?type=Pop" class="list-group-item">
                            Pop
                          </a>
                          <a href="<%=basePath%>user/search_genre.do?type=Rock" class="list-group-item">
                            Rock
                          </a>
                          </c:when>
                          <c:when test="${'Jazz' eq type}">
                          <a href="<%=basePath%>user/search_genre.do?type=All" class="list-group-item">
                            All
                          </a>
                          <a href="<%=basePath%>user/search_genre.do?type=Jazz" class="list-group-item active">
                            Jazz
                          </a>
                          <a href="<%=basePath%>user/search_genre.do?type=Pop" class="list-group-item">
                            Pop
                          ...
                          <a href="<%=basePath%>user/search_genre.do?type=Pop" class="list-group-item active">
                            Pop
                          </a>
                          <a href="<%=basePath%>user/search_genre.do?type=Rock" class="list-group-item">
                            Rock
                          ...
                          <a href="<%=basePath%>user/search_genre.do?type=Rock" class="list-group-item active">
                            Rock
                          </a>
                          </c:when>
                        </c:choose>
                ...
                <section>
                  <section class="vbox">
                    <section class="scrollable padder-lg">
                      ...
                      <tbody>
                        <c:forEach var="t" items="${tracks}" varStatus="loop">
                        <tr>                    
                          <td>${loop.index + 1}</td>
