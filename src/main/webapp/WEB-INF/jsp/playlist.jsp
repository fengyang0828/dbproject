            ...
            <section>
              <section class="vbox">
                <section class="scrollable padder-lg w-f-md" id="bjax-target">
                  <div class="row">
                    <div class="col-md-12">
                      <h3 class="font-bold">${playlist.user.uname}'s Playlist: ${playlist.ptitle}</h3>
                              ...
                              <td class="text-right">
                                <div class="btn-group">
                                  ...
                                  <ul class="dropdown-menu pull-right">
                                    <li><a href="<%=basePath%>playlist/delete_track_from_playlist.do?pid=${pid}&tid=${t.tid}">Delete From Playlist</a></li>
                                  </ul>
                                </div>
                              </td>
                            </c:when>
